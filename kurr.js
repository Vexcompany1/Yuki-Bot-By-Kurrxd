...
const dtod = "62881037046507@s.whatsapp.net"
const otod = "62881037046507@s.whatsapp.net"
// STICKER WM
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                ...
                case 12: jamss = "Udh Pagi Jangan Lupa Sekolah Kak 🌞"; break;
                case 13: jamss = "Siang 🌞"; break;
                case 14: jamss = "Siang 🌞"; break;
                case 15: jamss = "Dah Siang Jangan Lupa tersenyum kak🌞"; break;
                case 16: jamss = "Sore ☀️"; break;
                case 17: jamss = "Sore 🌄"; break;
                case 18: jamss = "Dah Sore Jangan Lupa Mandi Kak 🌄"; break;
